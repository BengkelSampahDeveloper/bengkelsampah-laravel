...
<body>
    ...
    <header class="header">
        <div class="header-left">
            ...
            <span class="header-subtitle">Tambah Kategori</span>
        </div>
        <div class="user-info">
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-upload" onclick="submitForm()">Simpan Kategori</button>
                </div>
            </div>
            ...
            <form id="categoryForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="nama" placeholder="Masukkan nama kategori" required>
    ...
    <script>
        ...
        function submitForm() {
            ...
            fetch('{{ route("dashboard.category.store") }}', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    alert('Gagal membuat kategori: ' + data.message);
                }
            })
            .catch(error => {
                hideLoading();
