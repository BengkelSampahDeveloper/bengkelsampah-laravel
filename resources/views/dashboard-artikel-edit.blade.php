...
<head>
    ...
    <title>Ubah Artikel - Admin Panel</title>
...
<body>
    ...
    <header class="header">
        <div class="header-left">
            ...
            <span class="header-subtitle">Ubah Artikel</span>
        </div>
        <div class="user-info">
    ...
    <div class="main-container">
        <div class="form-container">
            <div class="form-header">
                <h2 class="form-title">Ubah Artikel</h2>
                <div class="form-actions">
                    <button type="button" class="btn-cancel" onclick="window.history.back()">Kembali</button>
                    <button type="submit" class="btn-update" onclick="submitForm()">Perbarui</button>
                </div>
            </div>
            ...
            <form id="articleForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-input" placeholder="Masukkan judul artikel" value="{{ old('title', $artikel->title) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-input content-editor" name="content" placeholder="Isi konten disini sesuka hati" rows="10" oninput="updateCharCount(this)" required>{{ old('content', $artikel->content) }}</textarea>
        ...
        <div class="category-sidebar">
            ...
            <div class="category-list" id="categoryList">
                ...
                <div class="category-item">
                    <div class="category-item-left" onclick="selectCategory({{ $kategori->id }}, '{{ $kategori->nama }}')">
                        <div class="category-radio {{ $artikel->kategori_id == $kategori->id ? 'selected' : '' }}" 
                             id="radio-{{ $kategori->id }}"></div>
    ...
    <script>
        let selectedCategoryId = {{ old('kategori_id', $artikel->kategori_id) }};
        ...
        function submitForm() {
            ...
            fetch(`/dashboard/artikel/{{ $artikel->id }}`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': csrfToken,
                    'Accept': 'application/json',
